...
load('../../experiments/PhageData_higherTreshold_2_20.mat')
...
load('../fits/PhageAttackParams_higherTreshold_2_20.mat')


% Prepare folders


if ~exist('../../figures/Figure S5_higherTreshold_2_20', 'dir')
    mkdir('../../figures/Figure S5_higherTreshold_2_20')
end
...
for i = 1:numel(I)
    ...
    % Save figure
    saveas(fh1, sprintf('../../figures/Figure S5_higherTreshold_2_20/Run_%d.png', i))
