...
load('../fits/PhageAttackParams_onlyEpsilon.mat')

% Prepare folders
if ~exist('../../figures/Figure S8', 'dir')
    mkdir('../../figures/Figure S8')
end

if ~exist('../../figures/Figure S9', 'dir')
    mkdir('../../figures/Figure S9')
end


% Get configration struct
p = getConfiguration(x, y, 4);
...
for i = 1:numel(I)
    ...
    % Save figure
    saveas(fh1, sprintf('../../figures/Figure S9/Run_%d.png', i))
    ...
    if any(I(i) == [I7_5 I8_0 I8_5 I9_0 I9_5 I7_5])
        ...
        saveas(fh3, sprintf('../../figures/Figure S8/FigS8%s.png', labels{I(i) == [I7_5 I8_0 I8_5 I9_0 I9_5]}))
    end
